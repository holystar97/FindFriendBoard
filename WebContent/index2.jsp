...
<head>
  ...
  <style>  
 .time{background-color:#EBA174; /*검정색*/
		color:#BD500F;      /*진한노랑색*/
		font-weight:bold;
...
<div class="container-fluid bg-1 text-center">
  <h3 class="margin">Welcome To Vist FindFriend Pages</h3>
  <img src="./images/friend.gif" class="img-responsive img-circle margin" style="display:inline" alt="Bird" width="350" height="350">
</div>
